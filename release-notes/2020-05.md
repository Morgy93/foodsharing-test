...
Wir haben [Notizen im Changelog](https://foodsharing.de/content?sub=changelog) gesichtet, diskutiert und formuliert. Nun haben wir bündig zusammengefasst, was sich für dich ändert, 
...
Wenn etwas unklar geblieben ist, schau gerne im [Changelog](https://foodsharing.de/content?sub=changelog) nach und klickt auf die Ausrufezeichen (!) und Rauten (#), die du dort findest. Und wenn dann noch Fragen sind, frag gerne [it@foodsharing.network](mailto:it@foodsharing.network?subject=Frage-zu-Release-Notes).
