...
class RegularPickupGatewayTest extends \Codeception\Test\Unit
{
    ...
    private function testRegularPickupRangeByStartDay(Carbon $startDate)
    {
    ...
    public function testGetRegularPickupsRangeAtEndOfWeek()
    {
    ...
    public function testGetRegularPickupsRangeAtMidOfWeek()
    {
    ...
    private function checkGetRegularPickupsInRange($start, $end, $expectedCount)
    {
    ...
    public function testGetRegularPickupsInRangeDaySo()
    {
    ...
    public function testGetRegularPickupsInRangeDayDi()
    {
        $storeId = $this->store['id'];
    ...
    public function testGetRegularPickupsInRangeDaySa()
    {
        $storeId = $this->store['id'];
    ...
    public function testGetRegularPickupsInRangeDaySpecialt()
    {
        $date = '2022-12-18';
        $time = '16:40:00';
    ...
    private function checkRangeOfGeneration($regularPickup, $start, $end, $expectedCount)
    {
        $startDate = Carbon::createFromFormat('Y-m-d H:i:s', $start);
        $endDate = Carbon::createFromFormat('Y-m-d H:i:s', $end);
    ...
    public function testConvertRegularPickup()
    {
