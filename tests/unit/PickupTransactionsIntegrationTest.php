...
class PickupTransactionsIntegarionTest extends \Codeception\Test\Unit
{
    ...
    public function testRegularPickupsInRange()
    {
        $date = '2022-12-18';
        $time = '16:40:00';
    ...
    public function testOverrideRegularPickupsByOneTimePickupInRange()
    {
        $date = '2022-12-18';
        $time = '16:40:00';
        $startDate = Carbon::createFromFormat('Y-m-d H:i:s', $date . ' 16:50:01');
