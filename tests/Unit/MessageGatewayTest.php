...
class MessageGatewayTest extends Unit
{
    ...
    public function testGetOrCreateConversationGetsExistingConversation(): void
    {
    ...
    public function testGetOrCreateConversationGetsNewConversation(): void
    {
        $fsa = $this->tester->createFoodsaver();
        $fsb = $this->tester->createFoodsaver();
    ...
    public function testSetConversationMembers(): void
    {
        $fsa = $this->tester->createFoodsaver();
        $fsb = $this->tester->createFoodsaver();
        $fsc = $this->tester->createFoodsaver();
