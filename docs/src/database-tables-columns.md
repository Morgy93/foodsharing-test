...
This page is automatically generated and can be manually generated with [database scripts](scripts.md#database-scripts).
## Introduction
...
~~~
  ...
  - [fs_abholzeiten](#table-fs_abholzeiten) (DELETE, UPDATE)
  - [fs_bezirk](#table-fs_bezirk) (SELECT, UPDATE)
